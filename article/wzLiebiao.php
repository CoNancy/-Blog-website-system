...
<html lang="zh-CN">
  <head>
    ...
    <![endif]-->
    <link rel="stylesheet" type="text/css" href="wzLiebiao.css" >
  </head>
              ...
              <li><a href="#">您已登录</a></li>
                ...
                <ul class="dropdown-menu">
                 <li><a href="http://localhost:8080/grBoke/grBoke.php">个人博客</a></li>
                  ...
                  <li><a href="http://localhost:8080/home/home.html">注销登录</a></li>
    ...
    <div class="container">
      ...
      <div class="row row-type">
        ...
        <div class="col-sm-8 blog-main">
          ...
          <div class="blog-post">
            <div class="add-type" style="width:100%">
              <button style="border:none;border-radius:5px;background-color:#9999ff;color:white;height:30px;"><a href="http://localhost:8080/article/Modifyarticle.php" style="color:white">添加文章</a></button>
...
<script type="text/javascript">
  ...
  console.log("11");
      ...
      $.ajax({
    type:"GET",
    url:"http://localhost:8080/grBoke/grBoke.inc.php",
    data:{id:"123456"},
    dataType:"json",
    ...
    for(var i=0;i<msg.length;i++){
	  $(".artical").append("<table data-num=" + msg[i].num + "><tr ><td class='artical-type'><a href='#'>"+msg[i].title+"~</a></td>"+
	       "<td class='delete-button'><button class='reWriteBtn' style='border:none;border-radius:2px;background-color:#9999ff;color:white;'>"+
		   "修改</button><button style='border:none;border-radius:2px;background-color:#9999ff;color:white;margin-left:5px' class='removeBtn'>删除</button></td></tr></table>");
    
    }
    $('.reWriteBtn').click(function(event){
      console.log
      window.location.href='http://localhost:8080/article/updateArticle.php?num='+ $(this).closest('table')[0].dataset.num;
    });
    
    $(".removeBtn").click(function(event){
      console.log($(event.target).closest("table").attr("data-num"));
      $.ajax({
        type:"GET",
        url:"http://localhost:8080/article/article.del.handle.php",
        data:{num:$(event.target).closest("table").attr("data-num")},
        dataType:"text",
        success:function(msg){
          console.log(msg);
          alert("删除成功");
